...
class _SplashScreenState extends State<SplashScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _scaleAnimation = Tween<double>(begin: 0.8, end: 1.0).animate( // Mulai dari 80% ukuran asli
      CurvedAnimation(
    ...
    Timer(const Duration(seconds: 4), () {
      ...
      if (mounted) {
        Navigator.of(context).pushReplacement(
          MaterialPageRoute(builder: (context) => const LoginRegisterScreen()), // Ganti dengan halaman utama Anda
        );
      }
    });
          ...
          children: [
            ...
            FadeTransition(
              ...
              child: ScaleTransition(
                ...
                child: Image.asset(
                  'assets/images/WhatsApp Image 2025-06-24 at 14.06.07.jpeg', // Path gambar logo Anda
